...
export function renderWhatsAppSettingsView(data = {}) {
  ...
  return `
    <div style="display: flex; flex-direction: column; gap: 1.5rem;" dir="rtl">
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 1rem;">
          <div>
            ...
            <p style="font-size: 0.85rem; color: var(--centrly-text); margin-top: 0.35rem; line-height: 1.6;">
              ربط رقم واتساب لإرسال روابط المتابعة والتقارير للطلاب وأولياء الأمور تلقائياً.
            </p>
          </div>
          ...
          <div style="background: var(--centrly-surface); border: 1px solid var(--centrly-line); border-radius: 8px; padding: 1.25rem; margin-top: 1.25rem; display: flex; gap: 1.5rem; align-items: center; flex-wrap: wrap;">
            ...
            <div style="flex: 1; min-width: 250px;">
              ...
              <p style="font-size: 0.825rem; color: var(--centrly-text); margin-bottom: 0.75rem;">
                امسح رمز QR من هاتفك عبر <strong>الأجهزة المرتبطة > ربط جهاز</strong> في تطبيق واتساب لتفعيل إرسال الرسائل.
              </p>
      ...
      <!-- WhatsApp Usage Guidelines Card -->
      <div class="card" style="margin: 0;">
        <div style="display: flex; align-items: center; gap: 0.5rem; margin-bottom: 0.5rem;">
          <span>${getIcon('info', 20, 'var(--centrly-blue-700)')}</span>
          <h3 style="margin: 0; font-size: 1.05rem; font-weight: 700; color: var(--centrly-ink);">
            إرشادات استخدام خدمة الواتساب
          </h3>
        </div>
        <p style="font-size: 0.85rem; color: var(--centrly-text); margin-bottom: 1rem; line-height: 1.6;">
          لضمان وصول الرسائل بسلاسة واستقرار الخدمة، يُرجى مراعاة الإرشادات التالية:
        </p>
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(260px, 1fr)); gap: 1rem;">
          ...
          <div style="background: var(--centrly-surface); padding: 1rem; border-radius: 8px; border: 1px solid var(--centrly-line);">
            ...
            <div style="font-size: 0.82rem; color: var(--centrly-text); line-height: 1.6;">
              تجنب إرسال كميات كبيرة من الرسائل دفعة واحدة في وقت قصير. يقوم النظام تلقائياً بوضع فواصل زمنية بسيطة بين الرسائل لضمان وصولها بثبات ودون انقطاع.
            </div>
          </div>
          ...
          <div style="background: var(--centrly-surface); padding: 1rem; border-radius: 8px; border: 1px solid var(--centrly-line);">
            ...
            <div style="font-size: 0.82rem; color: var(--centrly-text); line-height: 1.6;">
              يُستحسن تذكير أولياء الأمور والطلاب بحفظ رقمك في جهات الاتصال لديهم، مما يتيح لهم فتح روابط المتابعة والتقارير والواجبات مباشرة وبكل سهولة.
            </div>
          </div>
          ...
          <div style="background: var(--centrly-surface); padding: 1rem; border-radius: 8px; border: 1px solid var(--centrly-line);">
            ...
            <div style="font-size: 0.82rem; color: var(--centrly-text); line-height: 1.6;">
              يكفي إرسال رابط البوابة لمرة واحدة لكل طالب وولي أمر؛ فالرابط دائم ومحدث تلقائياً بالحضور والغياب ودرجات الكويزات والواجبات والمذكرات دون الحاجة لإرسال رسائل متكررة كل يوم.
            </div>
          </div>
        ...
        <div class="card-header">
          <div>
            ...
            <p style="font-size: 0.8rem; color: var(--centrly-text); margin: 0.25rem 0 0;">
              نماذج الرسائل التي ترسل للطلاب وأولياء الأمور، مع إدراج الأسماء والروابط تلقائياً لكل طالب.
            </p>
          </div>
        </div>
