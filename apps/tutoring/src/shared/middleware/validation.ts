...
export const createGroupSchema = z.object({
  ...
  billing_model: z.enum(["percentage", "fixed_per_student", "fixed_rent", "no_center"]).optional().default("percentage"),
...
export const updateGroupSchema = z.object({
  ...
  billing_model: z.enum(["percentage", "fixed_per_student", "fixed_rent", "no_center"]).optional(),
